...
if __name__ == "__main__":
    ...
    #REFERENCE
    #Rune (2022) OpenCV and python: Simple noise-tolerant motion detector, Learn Python With Rune. Available at: https://www.learnpythonwithrune.org/opencv-and-python-simple-noise-tolerant-motion-detector/ (Accessed: December 13, 2022). 
